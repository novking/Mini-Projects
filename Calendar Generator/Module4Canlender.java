/**********
 * This program generates a calendar for a month based on user inputs
 *pre-condition: user input of month must be an integer in between 1 and 12
